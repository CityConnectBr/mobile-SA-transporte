...
class CardEditFieldsTile extends StatefulWidget {
  ...
  @override
  _CardEditFieldsTileState createState() => _CardEditFieldsTileState(
      title: title, child: child, voidCallback: voidCallback);
}
...
class _CardEditFieldsTileState extends State<CardEditFieldsTile> {
  ...
  _CardEditFieldsTileState({this.title, this.child, this.voidCallback}) {}
