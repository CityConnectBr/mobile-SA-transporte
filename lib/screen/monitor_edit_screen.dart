...
class _MonitorEditScreenState extends State<MonitorEditScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          monitor?.id == null ? 'Novo Monitor' : "Monitor",
        ),
        centerTitle: true,
      ),
      body: ListView(
        children: <Widget>[
          ...
          Center(
            child: [
              MonitorEditDadosTile(_scaffoldKey, monitor ?? Monitor()),
              MonitorEditEnderecoTile(_scaffoldKey, monitor ?? Monitor()),
