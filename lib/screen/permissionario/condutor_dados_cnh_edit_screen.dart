  ...
  Widget build(BuildContext context) {
    ...
    if (!this._flagIsLoad) {
      ...
      if (condutorStore.solicitacaoExistente) {
        ...
        _vencimentoCNHController.text =
            condutorStore.condutor?.vencimentoCNH != null
                ? Util.dateFormatddMMyyyy
                    .format(condutorStore.condutor!.vencimentoCNH!)
                : "";
      }
    }
                            ...
                            children: <Widget>[
                              Container(
                                ...
                                child: CustomDropdown(
                                  ...
                                  hint: Text("CATEGORIA"),
                                  value: this
                                      ._categoriaCNH, //this._categoriaCNH ?? "A", //!= null ? this._categoriaCNH : "",
                                  onChanged: (newValue) {
                                    setState(() {
                                      print(newValue);
                                  ...
                                  CustomDialog().showConfirmDialog(
                                      ...
                                      voidCallbackSim: () {
                                        condutorStore.saveCNHCondutor(
                                            ...
                                            validade: Util.dateFormatddMMyyyy
                                                .parse(this
