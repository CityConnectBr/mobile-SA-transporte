              ...
              if (!_flagIsLoad) {
                ...
                if (_veiculoStore.solicitacaoExistente) {
                  _placaController.text =
                      _veiculoStore.solicitacaoDeAlteracao?.campo1 ?? '';
                  _renavanController.text =
                      _veiculoStore.solicitacaoDeAlteracao?.campo2 ?? '';
                  idMarcaModeloSelectd =
                      _veiculoStore.solicitacaoDeAlteracao?.campo3 ?? '';
                  _chassiController.text =
                      _veiculoStore.solicitacaoDeAlteracao?.campo4 ?? '';
                  idTipoCombustivelSelectd =
                      _veiculoStore.solicitacaoDeAlteracao?.campo5 ?? '';
                  _anoDeFabricacaoController.text =
                      _veiculoStore.solicitacaoDeAlteracao?.campo6 ?? '';
                  _anoDoModeloController.text =
                      _veiculoStore.solicitacaoDeAlteracao?.campo7 ?? '';
                  idCorSelectd =
                      _veiculoStore.solicitacaoDeAlteracao?.campo8 ?? '';
                  idTipoSelectd =
                      _veiculoStore.solicitacaoDeAlteracao?.campo9 ?? '';
                  _tipoDaCapacidade =
                      _veiculoStore.solicitacaoDeAlteracao?.campo10 ?? '';
                  _capacidadeController.text =
                      _veiculoStore.solicitacaoDeAlteracao?.campo11 ?? '';
                  _observacaoDaCapacidadeController.text =
                      _veiculoStore.solicitacaoDeAlteracao?.campo12 ?? '';
                  _anosDeVidaUtilDoVeiculoController.text =
                      _veiculoStore.solicitacaoDeAlteracao?.campo13 ?? '';
                } else {
                  _placaController.text = _veiculoStore.veiculo?.placa ?? '';
                  _renavanController.text = _veiculoStore.veiculo?.renavam ?? '';
                  idMarcaModeloSelectd = Util.toStringIfIsNotNull(
                      _veiculoStore.veiculo?.marcaModeloVeiculoId);
                  _chassiController.text = _veiculoStore.veiculo?.chassi ?? '';
                  idTipoCombustivelSelectd = Util.toStringIfIsNotNull(
                      _veiculoStore.veiculo?.tipoCombustivelId);
                  _anoDeFabricacaoController.text = Util.toStringIfIsNotNull(
                          _veiculoStore.veiculo?.anoDeFabricacao) ??
                      '';
                  _anoDoModeloController.text = Util.toStringIfIsNotNull(
                          _veiculoStore.veiculo?.anoDoModelo) ??
                      '';
                  idCorSelectd =
                      Util.toStringIfIsNotNull(_veiculoStore.veiculo?.corId);
                  idTipoSelectd = Util.toStringIfIsNotNull(
                      _veiculoStore.veiculo?.tipoVeiculoId);
                  _tipoDaCapacidade = _veiculoStore.veiculo?.tipoDaCapacidade;
                  _capacidadeController.text =
                      _veiculoStore.veiculo?.capacidade ?? '';
                  _observacaoDaCapacidadeController.text =
                      _veiculoStore.veiculo?.observacaoDaCapacidade ?? '';
                  _anosDeVidaUtilDoVeiculoController.text =
                      Util.toStringIfIsNotNull(
                              _veiculoStore.veiculo?.anosDeVidaUtilDoVeiculo) ??
                          '';
                }

                //setando itens do autocomplete
                if (idMarcaModeloSelectd != null &&
                    idMarcaModeloSelectd?.isNotEmpty == true) {
                  _veiculoStore
                ...
                if (idTipoCombustivelSelectd != null &&
                    idTipoCombustivelSelectd?.isNotEmpty == true) {
                  _veiculoStore
                ...
                if (idCorSelectd != null && idCorSelectd?.isNotEmpty == true) {
                  _veiculoStore
                ...
                if (idTipoSelectd != null &&
                    idTipoSelectd?.isNotEmpty == true) {
                  _veiculoStore
                      .findTipoVeiculoById(idTipoSelectd!)
                      .then((value) => {
                            if (value != null)
                              {
                                _tipoVeiculoController.text =
                                    value.descricao ?? ''
                              }
                          });
                }
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                child: CustomDropdown(
                                  ...
                                  value: _findCapacidadeSelecionada(
                                      _tipoDaCapacidade ?? ''),
                                  onChanged: (newValue) {
                                    setState(() {
                                      _tipoDaCapacidade = newValue;
                                    });
                                  },
                                ),
                              ),
