...
class _VeiculoEditScreenState extends State<VeiculoEditScreen>
  ...
  Widget build(BuildContext context) {
    ...
    if (!_flagIsLoad) {
      ...
      _observacaoDaCapacidadeController.text = _veiculo.observacaoDaCapacidade;
      _anosDeVidaUtilDoVeiculoController.text =
          _veiculo.anosDeVidaUtilDoVeiculo != null
              ? _veiculo.anosDeVidaUtilDoVeiculo.toString()
              : "";
      _marcaModeloVeiculoController.text = _veiculo.marcaModeloVeiculo != null
          ? _veiculo.marcaModeloVeiculo.descricao
          : "";
      _tipoCombustivelController.text = _veiculo.tipoCombustivel != null
          ? _veiculo.tipoCombustivel.descricao
          : "";
      _corController.text =
          _veiculo.corVeiculo != null ? _veiculo.corVeiculo.descricao : "";
    }
                      ...
                      ? CustomRaisedButtonBlue(
                          ...
                          func: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) =>
                                    EmissaoDeMultaScreen(_veiculo, _scaffoldKey)));
                          })
                      : Container()
                ],
              ),
